...
void ResourceManager::CreateCube(std::string object_name) { //pulled this cube function out of my assignment 1
	...
	GLfloat vertex[] = {
		...
		-0.5, -0.5,  0.5,    0.0,  0.0,  1.0,    0.4, 0.1, 0.1,
		// Second cube face
		0.5, -0.5,  0.5,    1.0,  0.0,  0.0,    0.1, 0.45, 0.45,
		0.5, -0.5, -0.5,    1.0,  0.0,  0.0,    0.1, 0.45, 0.45,
		0.5,  0.5, -0.5,    1.0,  0.0,  0.0,    0.1, 0.45, 0.45,
		0.5,  0.5, -0.5,    1.0,  0.0,  0.0,    0.1, 0.45, 0.45,
		0.5,  0.5,  0.5,    1.0,  0.0,  0.0,    0.1, 0.45, 0.45,
		0.5, -0.5,  0.5,    1.0,  0.0,  0.0,    0.1, 0.45, 0.45,
		// Third cube face
		0.5, -0.5, -0.5,    0.0,  0.0, -1.0,    0.4, 0.1, 0.4,
		-0.5, -0.5, -0.5,    0.0,  0.0, -1.0,    0.4, 0.1, 0.4,
		-0.5,  0.5, -0.5,    0.0,  0.0, -1.0,    0.4, 0.1, 0.4,
		-0.5,  0.5, -0.5,    0.0,  0.0, -1.0,    0.4, 0.1, 0.4,
		0.5,  0.5, -0.5,    0.0,  0.0, -1.0,    0.4, 0.1, 0.4,
		0.5, -0.5, -0.5,    0.0,  0.0, -1.0,    0.4, 0.1, 0.4,
		// Fourth cube face
		-0.5, -0.5, -0.5,   -1.0,  0.0,  0.0,    0.45, 0.45, 0.1,
		-0.5, -0.5,  0.5,   -1.0,  0.0,  0.0,    0.45, 0.45, 0.1,
		-0.5,  0.5,  0.5,   -1.0,  0.0,  0.0,    0.45, 0.45, 0.1,
		-0.5,  0.5,  0.5,   -1.0,  0.0,  0.0,    0.45, 0.45, 0.1,
		-0.5,  0.5, -0.5,   -1.0,  0.0,  0.0,    0.45, 0.45, 0.1,
		-0.5, -0.5, -0.5,   -1.0,  0.0,  0.0,    0.45, 0.45, 0.1,
		// Fifth cube face
		-0.5,  0.5,  0.5,    0.0,  1.0,  0.0,    0.1, 0.1, 0.55,
		0.5,  0.5,  0.5,    0.0,  1.0,  0.0,    0.1, 0.1, 0.55,
		0.5,  0.5, -0.5,    0.0,  1.0,  0.0,    0.1, 0.1, 0.55,
		0.5,  0.5, -0.5,    0.0,  1.0,  0.0,    0.1, 0.1, 0.55,
		-0.5,  0.5, -0.5,    0.0,  1.0,  0.0,   0.1, 0.1, 0.55,
		-0.5,  0.5,  0.5,    0.0,  1.0,  0.0,    0.1, 0.1, 0.55,
		// Sixth cube face
		0.5, -0.5,  0.5,    0.0, -1.0,  0.0,    0.1, 0.55, 0.1,
		-0.5, -0.5,  0.5,    0.0, -1.0,  0.0,    0.1, 0.55, 0.1,
		-0.5, -0.5, -0.5,    0.0, -1.0,  0.0,    0.1, 0.55, 0.1,
		-0.5, -0.5, -0.5,    0.0, -1.0,  0.0,     0.1, 0.55, 0.1,
		0.5, -0.5, -0.5,    0.0, -1.0,  0.0,     0.1, 0.55, 0.1,
